...
3. The relevant_files MUST be actual file paths with extensions (e.g., .py, .js, .ts, .java) from the repository, NOT directories
   - ✓ CORRECT: pacai/core/agent.py, pacai/pacman/game.py
   - ✗ WRONG: pacai/core, pacai/agents (these are directories)
   - Include 3-8 specific files per page that are most relevant to that topic
